...
if sys.platform == "win32":
    ...
    if "fcntl" not in sys.modules:
        ...
        fake_fcntl.lockf = lambda *_args, **_kwargs: None
        fake_fcntl.fcntl = lambda *_args, **_kwargs: 0
        fake_fcntl.ioctl = lambda *_args, **_kwargs: 0
    ...
    if "resource" not in sys.modules:
        ...
        fake_resource.getrlimit = lambda *_args, **_kwargs: (8192, 8192)
        fake_resource.setrlimit = lambda *_args, **_kwargs: None
    ...
    def _shimmed_socketpair(*args: Any, **kwargs: Any) -> tuple[Any, Any]:
